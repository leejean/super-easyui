    ...
    if(op.inputLimit){
        ...
        var param = [];
         for(var index in rules){
           ...
           if(rule.length > 1){
             var param = JSON.parse(rule[1]);
           }
           var rule = rule[0];
           value = $.fn.validatebox.defaults.inputLimitRules[rule](value,param);
           $(this).val(value);
         }
    }
  }
...
$.extend($.fn.validatebox.defaults.inputLimitRules, {
    ...
    float:function(value,param){
     ...
     var split2 = param[1].toString().split(".");
     var f1 = parseInt(split1[0]);
    
      var f2 = parseInt(split2[0]);
      ...
      if(f1==f2){
        if(split1.length>1&&split2.length>1){
          var t1 = parseInt(split1[1]);
          var t2 = parseInt(split2[1]);
          if(t1>t2){
             value = param[1];
          }
        }
